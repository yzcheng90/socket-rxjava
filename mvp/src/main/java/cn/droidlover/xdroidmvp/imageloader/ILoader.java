...
public interface ILoader {
    ...
    class Options {
        ...
        public int radius = RES_NONE;
        public ImageView.ScaleType scaleType = null;

        public static final int RES_NONE = -1;

        public static Options defaultOptions() {
            return new Options(XDroidConf.IL_LOADING_RES, XDroidConf.IL_ERROR_RES,-1);
        }

        public Options(int radius) {
            this.loadingResId = XDroidConf.IL_LOADING_RES;
            this.loadErrorResId = XDroidConf.IL_ERROR_RES;
            this.radius = -1;
        }
        ...
        public Options(int loadingResId, int loadErrorResId,int radius) {
            this.loadingResId = loadingResId;
            this.loadErrorResId = loadErrorResId;
            this.radius = radius;
        }
