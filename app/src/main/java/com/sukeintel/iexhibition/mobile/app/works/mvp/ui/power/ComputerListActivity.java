...
import com.sukeintel.iexhibition.mobile.app.works.mvp.adapter.power.ComputerAdapter;
...
import com.sukeintel.iexhibition.mobile.app.works.mvp.present.power.ComputerPresent;
...
public class ComputerListActivity extends BaseActivity<ComputerPresent> {
    ...
    public SimpleRecAdapter getAdapter() {
        if (adapter == null) {
            ...
            adapter.setRecItemClick(new RecyclerItemCallback<ResourceEntity, ComputerAdapter.ViewHolder>() {
                @Override
                public void onItemClick(int position, ResourceEntity model, int tag, ComputerAdapter.ViewHolder holder) {
    ...
    public void reLoad(){
        getmPresenter().getResourceListByType(ResourceEntity.ResourceType.Mediabox);
    }

    @Override
    public ComputerPresent newP() {
        return new ComputerPresent();
    }

    @Override
    public int getLayoutId() {
        return R.layout.activity_computer_list;
    }
