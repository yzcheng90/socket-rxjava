...
import com.sukeintel.iexhibition.mobile.app.works.mvp.adapter.screen.ScreenAdapter;
...
import com.sukeintel.iexhibition.mobile.app.works.mvp.present.screen.ScreenPresent;
...
public class ScreenLEDListActivity extends BaseActivity<ScreenPresent> {
        ...
        if (adapter == null) {
            ...
            adapter.setRecItemClick(new RecyclerItemCallback<ResourceEntity, ScreenAdapter.ViewHolder>() {
                ...
                public void onItemClick(int position, ResourceEntity model, int tag, ScreenAdapter.ViewHolder holder) {
                    ...
                    ScreenSetContextActivity.launch(context,bundle);
                }
            });
        }
        return adapter;
    ...
    public int getLayoutId() {
        return R.layout.activity_screen_ledlist;
    }
