package com.sukeintel.iexhibition.mobile.app.works.mvp.adapter.scene;
...
public class SceneAdapter extends SimpleRecAdapter<PlanEntity, SceneAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final PlanEntity item = data.get(position);

        //绑定数据
        holder.icon.setImageResource(R.mipmap.mainframe);
        holder.name.setText(item.getTitle());
        holder.address.setText(item.getMemo());
