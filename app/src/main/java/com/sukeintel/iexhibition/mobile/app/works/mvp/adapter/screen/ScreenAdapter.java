package com.sukeintel.iexhibition.mobile.app.works.mvp.adapter.screen;
...
public class ScreenAdapter extends SimpleRecAdapter<ResourceEntity, ScreenAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        //绑定数据
        holder.icon.setImageResource(R.mipmap.screen_icon);
