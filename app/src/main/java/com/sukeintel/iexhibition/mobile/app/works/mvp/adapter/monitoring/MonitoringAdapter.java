package com.sukeintel.iexhibition.mobile.app.works.mvp.adapter.monitoring;
...
public class MonitoringAdapter extends SimpleRecAdapter<CameraEntity, MonitoringAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final CameraEntity item = data.get(position);
