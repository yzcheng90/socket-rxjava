...
public class UpdateUtil {
    private static final String TAG = "sukeintl.update";
    private static final String PREFS = "sukeintl.update.prefs";
    private static final String KEY_IGNORE = "sukeintl.update.prefs.ignore";
    private static final String KEY_UPDATE = "sukeintl.update.prefs.update";
